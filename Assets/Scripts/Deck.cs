...
{
    public GameObject basicCard;    //asset do modelo b�sico de uma carta
    public int id;                  //identificador do baralho
    public string [] backTypes;     //tipos/cores da parte de tr�s do baralho

    public List<GameObject> cards;  //lista dos GameObjects referentes �s cartas do baralho
    ...
    //As cartas s�o adicionadas uma a uma no baralho, seguindo as especifica��es passadas
    ...
    public void ShuffleDeck()
    {
        for(int i = 0; i < cards.Count; i++)
        {
            ...
            //como as sprites s�o renderizadas com base na dist�ncia que essas est�o da c�mera, � importante variar o valor
            //da posi��o "Z" de cada uma, para o caso de um tipo de jogo em que as cartas ser�o sobrepostas
            Vector3 pos1, pos2;
